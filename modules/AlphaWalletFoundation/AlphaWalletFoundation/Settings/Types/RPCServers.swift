...
public enum RPCServer: Hashable, CaseIterable {
    ...
    public var name: String {
        ...
        case .fantom_testnet: return "Tomb"
    ...
    public var isTestnet: Bool {
        switch self {
        case .xDai, .phi, .classic, .main, .poa, .callisto, .binance_smart_chain, .artis_sigma1, .heco, .fantom, .avalanche, .candle, .polygon, .optimistic, .arbitrum, .palm, .klaytnCypress, .ioTeX, .fantom_testnet:
            return false
        case .kovan, .ropsten, .rinkeby, .sokol, .goerli, .artis_tau1, .binance_smart_chain_testnet, .heco_testnet, .avalanche_testnet, .mumbai_testnet, .optimisticKovan, .cronosTestnet, .palmTestnet, .arbitrumRinkeby, .klaytnBaobabTestnet, .ioTeXTestnet:
            return true
        case .custom(let custom):
...
//        case .fantom_testnet: return Constants.fantomTestMagicLinkHost
        ...
        case .fantom_testnet: return Constants.tombMagicLinkHost
        }
    }
    ...
    public var displayOrderPriority: Int {
        switch self {
        case .fantom_testnet: return 1
        case .fantom: return 2
        case .main: return 3
        case .xDai: return 4
        case .classic: return 5
        case .poa: return 6
        case .ropsten: return 7
        case .kovan: return 8
        case .rinkeby: return 9
        case .sokol: return 10
        case .callisto: return 11
        case .goerli: return 12
        case .artis_sigma1: return 246529
        case .artis_tau1: return 246785
        case .binance_smart_chain: return 13
        case .binance_smart_chain_testnet: return 14
        case .custom(let custom): return 300000 + custom.chainID
        case .heco: return 15
        case .heco_testnet: return 16
        case .fantom: return 17
        case .avalanche: return 19
        case .avalanche_testnet: return 20
        case .polygon: return 21
        case .mumbai_testnet: return 22
        case .optimistic: return 23
        case .optimisticKovan: return 24
        case .cronosTestnet: return 25
        case .arbitrum: return 26
        case .arbitrumRinkeby: return 27
        case .palm: return 28
        case .palmTestnet: return 29
        case .klaytnCypress: return 30
        case .klaytnBaobabTestnet: return 31
        case .phi: return 32
